...
public abstract class HoloPackets {
    ...
    public static void init() {
        try {
            ...
            inst = (HoloPackets) SimpleVersionControl.createNMS("me.arasple.mc.trhologram.nms.impl.HoloPacketsImp_v1_" + version).useCache().translate(TrHologram.getPlugin()).newInstance();
