 ...
 */
public abstract class TrHologramPlugin extends JavaPlugin {
    ...
    protected static TrHologramPlugin plugin;
    ...
    protected static boolean forge = Loader.forName("net.minecraftforge.classloading.FMLForgePlugin", false, TrHologramPlugin.class.getClassLoader()) != null;
    ...
    private static Class<?> getMainClass() {
        ...
        try {
            ZipFile zipFile = new ZipFile(toFile(TrHologramPlugin.class.getProtectionDomain().getCodeSource().getLocation().openStream(), file));
    ...
    private static void init() {
        ...
        if (!libFile.exists()) {
            // 本地资源检测
            InputStream resourceAsStream = TrHologramPlugin.class.getClassLoader().getResourceAsStream("TabooLib.jar");
    ...
    public static TrHologramPlugin getPlugin() {
        return plugin;
    }
